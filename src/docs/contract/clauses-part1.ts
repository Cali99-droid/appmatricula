...
export function addClausesPart1(
  ...
  doc.font('Helvetica').fontSize(9).text(C4_P1A, { align: 'justify' });
  ...
  doc.moveDown();
  doc.font('Helvetica').fontSize(9).text(C4_P5A, { align: 'justify' });
  ...
  doc.font('Helvetica').fontSize(9).text(C5_P5A, { align: 'justify' });
